        ...
        <div className="space-y-6">
          ...
          <div className="card-glass overflow-hidden">
            <div className="flex flex-col items-center text-center p-6 bg-gradient-to-b from-primary-500/5 to-transparent">
              <div className="h-40 w-40 rounded-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center text-white text-6xl font-bold mb-4 shadow-2xl shadow-primary-500/20 border-4 border-white dark:border-dark-700 overflow-hidden relative aspect-square">
                {member.photo ? (
                  <img 
                  ...
                  <span className="flex items-center justify-center w-full h-full select-none">{member.name.charAt(0)}</span>
                )}
              </div>
